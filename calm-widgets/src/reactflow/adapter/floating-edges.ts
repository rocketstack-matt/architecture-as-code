...
/**
 * Calculate the intersection point of a line from the center of one node
 * to another with the node's bounding box
 */
...
/**
 * Calculate edge parameters for floating edges between two nodes
 */
