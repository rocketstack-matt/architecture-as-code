...
//These types and interfaces are used in the top-level visualizer components e.g. Sidebar, ReactFlowVisualizer.
...
// SidebarProps is co-located with the Sidebar component in `../details/types.ts`.
// Re-exported here for backwards compatibility with the contracts barrel.
export type { SidebarProps } from '../../details/types.js';
